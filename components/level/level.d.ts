...
export declare type LevelModifierProps = {
    breakpoint?: Variables["breakpoints"];
};
export declare type LevelProps = HelpersProps & LevelModifierProps;
export declare const Level: Pick<React.ForwardRefExoticComponent<React.ElementType<any>>, "displayName" | "$$typeof"> & {
    ...
    Item: import("../../base/exotic").ForwardRefAsExoticComponent<import("./level-item").LevelItemProps, React.ElementType<any>>;
};
