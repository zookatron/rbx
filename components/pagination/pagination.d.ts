...
export declare type PaginationModifiers = {
...
export declare const Pagination: Pick<React.ForwardRefExoticComponent<React.ElementType<any>>, "displayName" | "$$typeof"> & {
    ...
    defaultProps: {
        ...
        className?: string | undefined;
    } & PaginationModifiers & Pick<any, string | number | symbol>>;
    displayName: string;
    ...
    Ellipsis: import("../../base/exotic").ForwardRefAsExoticComponent<Prefer<import("../../base/helpers").HelpersPropsOverrides, import("../../base/helpers/badge").BadgeHelpersProps & import("../../base/helpers/float").FloatHelpersProps & import("../../base/helpers/overflow").OverflowHelpersProps & import("../../base/helpers/overlay").OverlayHelpersProps & import("../../base/helpers/tooltip").TooltipHelpersProps & import("../../base/helpers/typography").TypographyHelpersProps & import("../../base/helpers/visibility").VisibilityHelpersProps & import("../../base/helpers/other").OtherHelpersProps & import("../../base/helpers/responsive").ResponsiveHelpersProps & {
        className?: string | undefined;
    }>, React.ElementType<any>>;
    Link: import("../../base/exotic").ForwardRefAsExoticComponent<import("./pagination-link").PaginationLinkProps, React.ElementType<any>>;
    List: import("../../base/exotic").ForwardRefAsExoticComponent<Prefer<import("../../base/helpers").HelpersPropsOverrides, import("../../base/helpers/badge").BadgeHelpersProps & import("../../base/helpers/float").FloatHelpersProps & import("../../base/helpers/overflow").OverflowHelpersProps & import("../../base/helpers/overlay").OverlayHelpersProps & import("../../base/helpers/tooltip").TooltipHelpersProps & import("../../base/helpers/typography").TypographyHelpersProps & import("../../base/helpers/visibility").VisibilityHelpersProps & import("../../base/helpers/other").OtherHelpersProps & import("../../base/helpers/responsive").ResponsiveHelpersProps & {
        className?: string | undefined;
    }>, React.ElementType<any>>;
    Step: import("../../base/exotic").ForwardRefAsExoticComponent<import("./pagination-step").PaginationStepProps, React.ElementType<any>>;
};
