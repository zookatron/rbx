...
export declare const BREADCRUMB_DEFAULTS: {
    ...
    separators: readonly ["arrow", "bullet", "dot", "succeeds"];
...
export declare type BreadcrumbModifierProps = {
...
export declare const Breadcrumb: Pick<React.ForwardRefExoticComponent<React.ElementType<any>>, "displayName" | "$$typeof"> & {
    ...
    Item: import("../../base/exotic").ForwardRefAsExoticComponent<import("./breadcrumb-item").BreadcrumbItemProps, React.ElementType<any>>;
};
