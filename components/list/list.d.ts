...
export declare const List: Pick<React.ForwardRefExoticComponent<React.ElementType<any>>, "displayName" | "$$typeof"> & {
    ...
    Item: import("../../base/exotic").ForwardRefAsExoticComponent<import("./list-item").ListItemProps, React.ElementType<any>>;
};
