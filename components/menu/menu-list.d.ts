...
export declare const MenuList: Pick<React.ForwardRefExoticComponent<React.ElementType<any>>, "displayName" | "$$typeof"> & {
    ...
    Item: import("../../base/exotic").ForwardRefAsExoticComponent<import("./menu-list-item").MenuListItemProps, React.ElementType<any>>;
};
