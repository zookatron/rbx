...
export declare type TabModifierProps = {
    active?: boolean;
};
export declare type TabProps = HelpersProps & TabModifierProps;
export declare const Tab: Pick<React.ForwardRefExoticComponent<React.ElementType<any>>, "displayName" | "$$typeof"> & {
    ...
    Group: import("../../base/exotic").ForwardRefAsExoticComponent<import("./tab-group").TabGroupProps, React.ElementType<any>>;
};
