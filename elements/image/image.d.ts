...
export declare type ImageModifierProps = {
    rounded?: boolean;
};
export declare type ImageProps = HelpersProps & ImageModifierProps;
export declare const Image: Pick<React.ForwardRefExoticComponent<React.ElementType<any>>, "displayName" | "$$typeof"> & {
    ...
    Container: import("../../base/exotic").ForwardRefAsExoticComponent<import("./image-container").ImageContainerProps, React.ElementType<any>>;
};
