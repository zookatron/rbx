...
export declare const BUTTON_DEFAULTS: {
    ...
    states: readonly ["hovered", "focused", "active", "loading"];
};
...
export declare type ButtonModifierProps = {
...
export declare const Button: Pick<React.ForwardRefExoticComponent<React.ElementType<any>>, "displayName" | "$$typeof"> & {
    ...
    Group: import("../../base/exotic").ForwardRefAsExoticComponent<import("./button-group").ButtonGroupProps, React.ElementType<any>>;
};
