...
export declare const CONTENT_ORDERED_LIST_DEFAULTS: {
    types: readonly ["lower-alpha", "lower-roman", "upper-alpha", "upper-roman"];
};
...
export declare type ContentOrderedListModifierProps = {
...
export declare const ContentOrderedList: Pick<React.ForwardRefExoticComponent<React.ElementType<any>>, "displayName" | "$$typeof"> & {
